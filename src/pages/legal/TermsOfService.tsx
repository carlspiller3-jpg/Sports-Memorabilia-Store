        ...
        <div className="min-h-screen bg-ivory py-12 lg:py-20">
            <div className="container mx-auto px-4 max-w-3xl">
                <div className="text-center mb-12">
                    <h1 className="text-3xl md:text-4xl font-serif font-bold text-charcoal mb-4">Terms of Service</h1>
                ...
                <div className="bg-white p-8 md:p-12 rounded-sm shadow-sm border border-stone/10 space-y-8 text-navy/80 leading-relaxed">
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-charcoal font-serif">1. Acceptance of Terms</h2>
                        <p>
                            By accessing and using Sports Memorabilia Store website, you accept and agree to be bound by the terms and provision of this agreement.
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-charcoal font-serif">3. Orders & Pricing</h2>
                        <p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-charcoal font-serif">4. Shipping & Delivery</h2>
                        <p>
                            ...
                            Unless there are exceptional circumstances, we make every effort to fulfill your order within 15 business days of the date of your order.
                        </p>
                    </section>

                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-charcoal font-serif">5. Governing Law</h2>
                        <p>
