            ...
            <section className="py-16 md:py-24">
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center space-y-8">
                        ...
                        <p className="text-lg text-charcoal/80 leading-relaxed font-light">
                            We don't rely on paper certificates that can be copied. We use digital technology to prove authenticity, and frame everything properly using materials that actually protect the item.
                        </p>
