...
const authenticityFeatures = [
    {
        title: "Smart Tag (NFC)",
        description: "Every item has a smart tag. Scan it with your phone to see it is 100% real.",
        icon: (
    ...
    {
        title: "Signing Proof",
        description: "We take photos when the player signs the item. You see the proof.",
        icon: (
            <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                    strokeLinecap="round"
    ...
    },
    {
        ...
        description: "Scan the tag with your phone. Instantly see that it is real and trace its history.",
        icon: (
            <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                    strokeLinecap="round"
    ...
    },
    {
        ...
        description: "We guarantee our items for life. If it is not real, we give you all your money back. We even pay for shipping.",
        icon: (
            <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                    strokeLinecap="round"
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <h2 className="text-3xl font-bold tracking-tight text-navy sm:text-4xl lg:text-5xl">
                                Guaranteed Real. Safe Forever.
                            </h2>
                            <p className="text-lg text-charcoal/70">
                                We check each item to make sure it is real. You can buy with trust. It is the perfect gift.
                            </p>
                        </div>
                                ...
                                <div className="text-center space-y-6 max-w-sm">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-charcoal/60">
                                            Every item has a smart tag. Scan it to see it is 100% real.
                                        </p>
                                    </div>
