...
export function Footer() {
    return (
        <footer className="bg-navy pt-8 pb-8 text-white print:hidden">
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex flex-col gap-1 items-start">
                        ...
                        <p className="text-white/20 text-xs">
                            Company Reg: 16854974 • VAT No: GB514026140 • Registered Office: 189 Greenwood, Walters Ash, High Wycombe, HP14 4XF
                        </p>
                    </div>
                    <div className="flex gap-6">
                        ...
                        <Link to="/refund-policy" className="text-white/40 hover:text-gold text-sm transition-colors">Refund Policy</Link>
                    </div>
                </div>
            </div>
        </footer>
